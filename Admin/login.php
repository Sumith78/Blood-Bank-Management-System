    ...
    <div class="nav_bg">
        ...
        <div style="height:500px;">
            <form method="post" enctype="multipart/form-data">
                ...
                <table cellpadding="0" cellspacing="0" width="600px" height="300px" class="tableborder"
                    ...
                    <tr>
                        <td colspan="2" align="center"><img src="Images/login2.png" width="300px" height="70px"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:top">
                            <table cellpadding="0" cellspacing="0" height="200px">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td><input type="submit" value="Log In" name="sbmt"
        ...
        <div class="ftr-bg">
            <div class="wrap">
                <div class="footer">
                    ...
                    <div class="copy">
                        <p class="title">© All Rights Reserved | Design by Mr. Sumith |</p>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
