...
$s="select * from camp,state,city where camp.state=state.state_id and camp.city=city.city_id";
    ...
    <table class="intro_tbl" cellpadding="0" cellspacing="0" class="tableborder" width="500" style="border:none">
   ...
   <a href="Admin/pic/<?php echo $data[5] ?>"data-lightbox="image-1"> <img src="Admin/pic/<?php echo $data[5] ?>" height="250px" width="460px" style="margin:auto; padding-left:20px" /></a></td></tr>
    ...
    <tr><td>&nbsp;</td></tr>
          ...
          <tr><td class="title"  style="vertical-align:middle">Organised By:<?php echo $data[2]; ?></td></tr>
		...
		<tr><td colspan="2"><p style=" font-size:16px; font-weight:bold"><?php echo $data[2]; ?></p></td></tr>
		</table>
