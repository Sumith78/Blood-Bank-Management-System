                ...
                <table cellpadding="0" cellspacing="0" width="1100px" style="margin:auto">
                    <tr>
                        <td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="800px" height="100px"
                                style="margin:auto; border:0px" class="tableborder">
                                <tr>
                                    <td align="center"><img src="Images/results.png" height="80px"
...
?>
                                <tr>
                                    <td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="700px" height="150px"
                                            style="margin:auto; border:none;" class="tableborder">


                                            <tr>
                                                <td width="100%" height="150px" align="center" backgroud="red"
                                                    style="vertical-align:middle" ;>

                                                    <a href="doner_pic<?php echo $data[8] ?>" data-lightbox="image-1">
                                                        <img src="doner_pic/<?php echo $data[8] ?>" height="100px"
                                                            width="100px"
                                                            style="margin:auto; padding-left:50px; padding-right:50px; float:left" /></a>
                                                </td>
        ...
        <div class="ftr-bg">
            <div class="wrap">
                <div class="footer">
                    ...
                    <div class="copy">
                        <p class="title">© All Rights Reserved | Design by Sumith |</p>
                    </div>
                    <div class="clear"></div>
                </div>
            </div>
